...
#date-enrolled label {
/blog/ python-projects-for-beginners / display: none;
}
    ...
    <section>
        ...
        <fieldset class="no-confirmation mother-details">
            ...
            <div>
                ...
                <label style="padding-left:0px; width: auto; cursor: pointer">
                    <input type="radio" name="concept.163455AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            ...
            <div>
                ...
                <label style="padding-left:0px; width: auto; cursor: pointer">
                    <input type="radio" name="concept.160085AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                           value="160429AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                    Alive
                </label><br/>
                ...
                <label style="padding-left:0px; width: auto; cursor: pointer">
                    <input type="radio" name="concept.160085AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                           value="180BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB">
                    Dead
        ...
        <fieldset class="no-confirmation baby-details">
            ...
            <div>
                ...
                <input id="birth-notification-number" type="text" name="" class="number numeric-range" value=""
                       placeholder="Birth Notification Number">
            </div>

            <div>
                <label>Initiation of BF<span class="required">*</span></label>
                <label style="padding-left:0px; width: auto; cursor: pointer">
                    <input type="radio" name="concept.161543AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                           value="1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                    Within 1 hour
                </label><br/>
            ...
            <div>
                ...
                <label style="padding-left:0px; width: auto; cursor: pointer">
                    <input type="radio" name="concept.112d5f03-8f9d-450b-bfc2-00ac13d96dd8"
                           value="1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                    Given
                </label><br/>
            ...
            <div style="border-top: 1px solid #eee; margin-top: 6px;">
                ...
                <label style="padding-left:0px; width: auto; cursor: pointer">
                    <input type="radio" name="concept.0285b54b-8ad8-46ae-a537-fe179c7ebadd"
                           value="1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                    Yes
                </label><br/>
                <label>&nbsp;</label>
            ...
            <div class="onerow floating-controls hiv-info">
                <div class="col4" style="width: 33%; margin: 0 1% 0 0">
                    <div class="testbox">
                        ...
                        <label>
                            <input id="prior-status-positive" type="radio" data-value="Positive"
                                   name="concept.86f816e4-d093-4e8e-93e3-be2a98c264ac"
                                   value="703AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                            Positive
                        </label><br/>

                        <label>
                            <input id="prior-status-negative" type="radio" data-value="Negative"
                                   name="concept.86f816e4-d093-4e8e-93e3-be2a98c264ac"
                        ...
                        <label>
                            <input id="prior-status-unknown" type="radio" data-value="Unknown"
                                   name="concept.86f816e4-d093-4e8e-93e3-be2a98c264ac"
                                   value="1067AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                            Unknown
                        </label>
                    </div>
                </div>
                ...
                <div class="col4" style="width: 33%; margin: 0 1% 0 0">
                    <div class="testbox">
                        ...
                        <label>
                            <input id="couple-counselled" type="radio" data-value="Yes"
                                   name="concept.e51dfd50-8e09-4202-815c-ddcb9d5cad8a"
                                   value="1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                            Yes
                        </label><br/>

                        <label>
                            <input id="couple-counselled" type="radio" data-value="No"
                                   name="concept.e51dfd50-8e09-4202-815c-ddcb9d5cad8a"
                                   value="1066AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                            No
                        </label>
                ...
                <div class="col4 last" style="width: 32%;">
                    <div class="testbox anc-results">
                        ...
                        <label>
                            <input id="prior-status-positive" type="radio" data-value="Positive"
                                   name="concept.299AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                                   value="703AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                            Positive
                        </label><br/>
            ...
            <div class="onerow floating-controls hiv-info">
                <div class="col4" style="width: 33%; margin: 0 1% 0 0">
                    <div class="testbox">
                        ...
                        <label>
                            <input type="radio" name="concept.5526AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                                   value="1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                            Yes
                        </label><br/>
                ...
                <div class="col4" style="width: 33%; margin: 0 1% 0 0">
                    <div class="testbox">
                        ...
                        <label>
                            <input type="radio" name="concept.161534AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
                                   value="1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA">
                            Yes
                        </label><br>
                        <label>
